package com.example.nfcallcards.creditCardNfcReader;
...
import com.example.nfcallcards.creditCardNfcReader.parser.EmvParser;
import com.example.nfcallcards.creditCardNfcReader.utils.Provider;
            ...
            if (mCard != null) {
                if (StringUtils.isNotBlank(mCard.getCardNumber())) {
                   /* mCardNumber = mCard.getCardNumber();
                    ...
                    Log.e("mHolderLastName", "--> " + mCard.getHolderLastname());
                    Log.e("mHolderFirstName", "--> " + mCard.getHolderFirstname());
